      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-20">
          ...
          >
            ...
            <span className="text-xs font-bold text-violet-400 uppercase tracking-widest">Legal Agreement</span>
          </motion.div>
          <motion.h1 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Last updated: April 2, 2026. Please read these terms carefully before using our marketplace.
          </motion.p>
        </div>
        ...
        <div className="space-y-12">
          <motion.section 
            ...
            viewport={{ once: true }}
            className="bg-[#161616] border border-white/5 rounded-3xl p-8 md:p-12 shadow-2xl"
          >
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <p className="text-gray-400">Users must be at least 18 years old or have parental consent.</p>
              </div>
              <div className="flex gap-4">
                <CheckCircle2 className="h-6 w-6 text-emerald-400 flex-shrink-0" />
                <p className="text-gray-400">Sellers must provide accurate descriptions and screenshots of their listings.</p>
              </div>
              <div className="flex gap-4">
                <CheckCircle2 className="h-6 w-6 text-emerald-400 flex-shrink-0" />
                <p className="text-gray-400">Fraudulent activity, including chargebacks or account recovery after sale, will result in permanent bans.</p>
              </div>
              <div className="flex gap-4">
                <CheckCircle2 className="h-6 w-6 text-emerald-400 flex-shrink-0" />
                <p className="text-gray-400">GameVault charges a 5% fee on all successful transactions to maintain the platform and escrow service.</p>
              </div>
            </div>
          </motion.section>
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-2xl font-bold text-white">3. Escrow & Payments</h2>
            </div>
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-2xl font-bold text-white">4. Prohibited Items</h2>
            </div>
            <p className="text-gray-400 leading-relaxed text-lg">
        ...
        <div className="mt-20 text-center">
          <p className="text-gray-500 text-sm">
            If you have any questions about these terms, please contact our <a href="/support" className="text-violet-400 hover:underline">Support Team</a>.
          </p>
        </div>
      </div>
    </div>
