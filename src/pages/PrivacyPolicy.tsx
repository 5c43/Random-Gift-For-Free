      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-20">
          ...
          >
            ...
            <span className="text-xs font-bold text-emerald-400 uppercase tracking-widest">Privacy Protection</span>
          </motion.div>
          <motion.h1 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Your privacy is our top priority. Learn how we protect your data at GameVault.
          </motion.p>
        </div>
        ...
        <div className="space-y-12">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                <div className="h-2 w-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                <p className="text-gray-400 leading-relaxed">
                  <span className="text-white font-bold">Communication:</span> We store chat messages between buyers and sellers to resolve disputes and ensure safety.
                </p>
              </div>
            </div>
          </motion.section>
          ...
          >
            ...
            <p className="text-gray-400 leading-relaxed text-lg">
              We do not sell your personal data to third parties. We only share information when necessary to complete a transaction (e.g., with payment processors like Ziina or PayPal) or when required by law.
            </p>
          </motion.section>
          ...
          >
            ...
            <p className="text-gray-400 leading-relaxed text-lg">
              You have the right to access, correct, or delete your personal information at any time. You can manage your profile settings in the dashboard or contact our support team for data deletion requests.
            </p>
          </motion.section>
        </div>
        ...
        <div className="mt-20 text-center">
          <p className="text-gray-500 text-sm">
            Questions about your privacy? Reach out to our <a href="/support" className="text-violet-400 hover:underline">Privacy Officer</a>.
          </p>
        </div>
      </div>
    </div>
